...
Route::resource('/personalia/shift', ShiftController::class);
Route::resource('/personalia/hari_kerja', HariKerjaController::class);
Route::resource('/personalia/hari_libur', HariLiburController::class);
Route::resource('/personalia/cuti', CutiController::class);
