            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    ...
                    <div class="ml-md-auto py-2 py-md-0">
                        <a href="{{ route('sekolah.create') }}" class="btn btn-secondary btn-round">Tambah @yield('title')</a>
                    </div>
                </div>
            </div>
        </div>
                                        ...
                                        @forelse ($sekolahs as $sekolah)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('sekolah.destroy', $sekolah->id) }}" method="POST" class="d-inline" onsubmit="return confirm('Yakin ingin menghapus?')">
                                                        @csrf
                                                        @method('DELETE')
