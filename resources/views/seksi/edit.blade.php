                        ...
                        <div class="card-body">
                            <form action="{{ route('seksi.update', $seksi->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="departemen_id" id="departemen" class="form-control @error('departemen_id') is-invalid @enderror">
                                        ...
                                        @foreach($departemens as $departemen)
                                            <option value="{{ $departemen->id }}" {{ old('departemen_id', $seksi->departemen_id) == $departemen->id ? 'selected' : '' }}>
                                                {{ $departemen->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $seksi->nama) }}" required autofocus>
                                    @error('nama')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
