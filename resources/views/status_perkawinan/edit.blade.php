            ...
            <div class="page-inner py-5">
                <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                    ...
                    <div class="ml-md-auto py-2 py-md-0">
                        <a href="{{ route('status_perkawinan.index') }}" class="btn btn-secondary btn-round">Kembali</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <form action="{{ route('status_perkawinan.update', $status_perkawinan->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $status_perkawinan->nama) }}" required autofocus>
                                    @error('nama')
