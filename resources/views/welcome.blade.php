                                        ...
                                        <table class="table">
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="flag">
                                                            <img src="/atlantis/assets/img/flags/us.png"
                                                                alt="united states">
                                                        </div>
                                                    </td>
                                                    <td>USA</td>
                ...
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body pb-0">
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="/atlantis/assets/img/logoproduct.svg" alt="..."
                            ...
                            <div class="d-flex">
                                <div class="avatar">
                                    <img src="/atlantis/assets/img/logoproduct3.svg" alt="..."
                                        class="avatar-img rounded-circle">
                                </div>
                                <div class="flex-1 pt-1 ml-2">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="card-list">
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="/atlantis/assets/img/jm_denis.jpg" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="/atlantis/assets/img/chadengle.jpg" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="/atlantis/assets/img/talha.jpg" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
                                ...
                                <div class="item-list">
                                    <div class="avatar">
                                        <img src="/atlantis/assets/img/mlane.jpg" alt="..."
                                            class="avatar-img rounded-circle">
                                    </div>
                                    <div class="info-user ml-3">
