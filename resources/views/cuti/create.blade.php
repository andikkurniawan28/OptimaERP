                    ...
                    <div class="card-body">
                        <form action="{{ route('cuti.store') }}" method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="dari" id="dari" class="form-control @error('dari') is-invalid @enderror" value="{{ old('dari') }}" required>
                                @error('dari')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" name="sampai" id="sampai" class="form-control @error('sampai') is-invalid @enderror" value="{{ old('sampai') }}" required>
                                @error('sampai')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
