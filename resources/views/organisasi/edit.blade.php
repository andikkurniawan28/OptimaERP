                        ...
                        <div class="card-body">
                            <form action="{{ route('organisasi.update', $organisasi->id) }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="jenis_organisasi_id" id="jenis_organisasi" class="form-control @error('jenis_organisasi_id') is-invalid @enderror">
                                        ...
                                        @foreach($jenis_organisasis as $jenis_organisasi)
                                            <option value="{{ $jenis_organisasi->id }}" {{ old('jenis_organisasi_id', $organisasi->jenis_organisasi_id) == $jenis_organisasi->id ? 'selected' : '' }}>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="bidang_usaha_id" id="bidang_usaha" class="form-control @error('bidang_usaha_id') is-invalid @enderror">
                                        ...
                                        @foreach($bidang_usahas as $bidang_usaha)
                                            <option value="{{ $bidang_usaha->id }}" {{ old('bidang_usaha_id', $organisasi->bidang_usaha_id) == $bidang_usaha->id ? 'selected' : '' }}>
                                                {{ $bidang_usaha->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="wilayah_id" id="wilayah" class="form-control @error('wilayah_id') is-invalid @enderror">
                                        ...
                                        @foreach($wilayahs as $wilayah)
                                            <option value="{{ $wilayah->id }}" {{ old('wilayah_id', $organisasi->wilayah_id) == $wilayah->id ? 'selected' : '' }}>
                                                {{ $wilayah->nama }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="kode" id="kode" class="form-control @error('kode') is-invalid @enderror" value="{{ old('kode', $organisasi->kode) }}" required>
                                    @error('kode')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nama" id="nama" class="form-control @error('nama') is-invalid @enderror" value="{{ old('nama', $organisasi->nama) }}" required>
                                    @error('nama')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nomor_handphone" id="nomor_handphone" class="form-control @error('nomor_handphone') is-invalid @enderror" value="{{ old('nomor_handphone', $organisasi->nomor_handphone) }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" value="{{ old('email', $organisasi->email) }}" required>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea name="alamat" id="alamat" class="form-control @error('alamat') is-invalid @enderror" required>{{ old('alamat', $organisasi->alamat) }}</textarea>
                                    @error('alamat')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="npwp" id="npwp" class="form-control @error('npwp') is-invalid @enderror" value="{{ old('npwp', $organisasi->npwp) }}">
                                    @error('npwp')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
